...
import AccountForm from '../wizard/AccountForm';
import PersonalForm from '../wizard/PersonalForm';
import BillingForm from '../wizard/BillingForm';
    ...
    <>
      ...
      >
        ...
        <Card.Body className="fw-normal px-md-6 py-4">
          {step === 1 && (
            <UserAccountForm register={register} errors={errors} watch={watch} />
          )}
          {step === 2 && (
            <UserPersonalForm
              register={register}
