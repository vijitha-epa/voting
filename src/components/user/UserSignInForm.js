  ...
  return (
    <>
      <Row className="my-5 g-4">
        ...
        {/*  <SignInTitle icon="spinner" title="Progress Tab" />*/}
        {/*  <WizardForm />*/}
        {/*</Col>*/}
        <Col lg={6} xl={12} xxl={6} className="mt-0 h-100">
          <SignInTitle icon="check-double" title="With Validation" />
          <WizardForm validation={true} />
        </Col>
      </Row>
      {/*<Row className="g-4">*/}
      {/*  <Col lg={6} xl={12} xxl={6} className="h-100">*/}
      {/*    <SignInTitle icon="tasks" title="With Progressbar" />*/}
